...
class FieldAdmin(admin.ModelAdmin):
    ...
    def activity_status(self, obj):
        ...
        return format_html(
            '<span style="background:{};color:{};padding:5px 10px;border-radius:999px;font-weight:700;">{}</span>',
            background,
            color,
            text,
        )
...
class BookingAdmin(admin.ModelAdmin):
    ...
    def colored_status(self, obj):
        ...
        background, color = styles.get(obj.status, ("#e5e7eb", "#374151"))
    ...
    def confirm_selected_bookings(self, request, queryset):
        ...
        self.message_user(request, f"Đã xác nhận {updated} đơn đặt sân.")
    ...
    def complete_selected_bookings(self, request, queryset):
        ...
        self.message_user(request, f"Đã hoàn thành {updated} đơn đặt sân.")
    ...
    def cancel_selected_bookings(self, request, queryset):
        ...
        self.message_user(request, f"Đã hủy {updated} đơn đặt sân.")
...
class ReviewAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            "Thông tin đánh giá",
            {"fields": ("booking", "user", "field", "rating", "comment")},
        ),
        (
            "Thông tin hệ thống",
            {
    ...
    def rating_display(self, obj):
        ...
        return format_html(
            '<span style="color:#f59e0b;font-size:16px;font-weight:700;">{}{}</span>',
            stars,
            empty_stars,
        )
